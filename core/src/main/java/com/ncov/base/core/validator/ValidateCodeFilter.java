...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
     ...
     */
    @Autowired
    private SystemSecurityProperties securityProperties;
    /**
     * 系统中的校验码处理器
     */
    @Autowired
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        urlMap.put(SecurityConstants.LOGIN_PROCESS_URL, ValidateCodeType.IMAGE);
        addUrlToMap(securityProperties.getValidate().getImage().getUrl(), ValidateCodeType.IMAGE);

        urlMap.put(SecurityConstants.LOGIN_PROCESS_URL_MOBILE, ValidateCodeType.SMS);
